---
title: "Impact of Severe Weather Events on Public Health and Economy in the United States [Reproducible Research : Project2 ]"
author: "jshiju"
...
Download the data from NOAA Storm Database site and unzip it.
...
Read the generated csv file. If the data already exists in the working environment, we do not need to load it again. Otherwise, we read the csv file.

```r
# use 'cache' as preprocessing is time-consuming
...
* (a) Analysing Impact on Public Health
...
Aggregate them by eventtype and sort in the descending order
...
Figure (2) - Fatalities and Injuries based on weather event types
...
Based on the analysis performed above, we can arrive at the following conclusions:

1. The weather event types **excessive heat** and **tornado** are most harmful with respect to population health and
2. Event types **flood**, **drought**, and **hurricane/typhoon** have the greatest economic consequences.
